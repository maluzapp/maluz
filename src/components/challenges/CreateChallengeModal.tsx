  ...
  const handleSend = async (shareVia?: 'whatsapp') => {
    ...
    try {
      ...
      if (shareVia === 'whatsapp') {
        ...
        const text = ['💡 *Maluz — Novo Desafio!*', '', '🎯 ' + childName + ', seu pai/mãe mandou um desafio para você!', '📖 ' + subject + ' — ' + topic, message ? ('💬 "' + message + '"') : '', '🚀 Abra o Maluz e mostre que você sabe!', 'https://maluz.app'].filter(Boolean).join('\n');
